...
/*
 * OPERATOR==:
 * Function that compares the catnums of two eclipses.
 * Returns true if eclipses are equal and false otherwise
 *
 * Author: Clayton Glenn
 */
bool Eclipse::operator==(const Eclipse &e1) {
	if (this->catNum == e1.catNum) {
		return true;
	}
	return false;
}
 ...
 * OPERATOR>:
 * Function that compares the catnums of two eclipses.
 * Returns true if e1 is greater than e2 and false otherwise
 *
 * Author: Clayton Glenn
 */
bool Eclipse::operator>(const Eclipse &e1) {
 ...
 * OPERATOR<:
 * Function that compares the catnums of two eclipses.
 * Returns true if e1 is less than e2 and false otherwise
 *
 * Author: Clayton Glenn
 */
bool Eclipse::operator<(const Eclipse &e1) {
