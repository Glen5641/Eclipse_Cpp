...
/*
 * Overloaded Constructor for Creating ResizableArray with User Specified Elements.
 *
 * Author: Clayton Glenn
 */
template<class T>
...
/*
 * Copy Constructor for Initiallizing ResizableArray with another ResizableArray
 *
 * Author: Clayton Glenn
 */
template<class T>
...
/*
 * Overloads =Operator to Initiallize ResizableArray with another ResizableArray
 *
 * Author: Clayton Glenn
 */
template<class T>
...
std::ostream& operator<<(std::ostream& os, const ResizableArray<T>* ra) {
	...
	//Capture array to stop element access
	T * array = ra->array;

	//Print each element of array
	for (int count = ra->size - 1; count >= 0; --count) {
		os << *array[count];
	}
...
/*
 * Accessor Function: Returns a specific object of the resizable array
 *
 * Author: Clayton Glenn
 */
template<class T>
...
/*
 * Mutator Method: Adds an object to the end of the array and increments size
 *
 * Author: Clayton Glenn
 */
template<class T>
...
/*
 * Mutator Function: Adds an object at a specified index to array and increments size
 *
 * Author: Clayton Glenn
 */
template<class T>
...
/*
 * Mutator Function: Replaces an object at a specified index to array
 *
 * Author: Clayton Glenn
 */
template<class T>
